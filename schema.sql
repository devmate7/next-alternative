...
CREATE TABLE `Course` (
	...
	`TeaserSN` INTEGER NOT NULL REFERENCES `File` (`SN`) /* 前導廣告序號 */,
...
CREATE TABLE `Order` (
	...
	`LearnerSN` INTEGER NOT NULL REFERENCES `User` (`SN`) /* 學員序號 */,
	`LearnerCouponSN` INTEGER NOT NULL REFERENCES `LearnerCoupon` (`SN`) /* 學員優惠券序號 */
) /* 訂單 */;
...
CREATE TABLE `Session` (
	`Identifier` CHAR(32) NOT NULL UNIQUE /* 識別碼 */,
	`IP` CHAR(32) NOT NULL /* IP 位址 */,
	`UserAgent` CHAR(32) NOT NULL UNIQUE /* 使用者代理 */,
	`WhenGranted` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP /* 授予時間 */,
	`WhenExpired` DATETIME NOT NULL /* 到期時間 */,
	`WhenRevoked` DATETIME NULL /* 撤銷時間 */,
	`WhenConsumed` DATETIME NULL /* 撤銷時間 */,
...
CREATE TABLE `Session` (
	`` CHAR(32) NOT NULL UNIQUE /* 使用者名稱 */,
	`WhenGranted` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP /* 授予時間 */,
	`WhenExpired` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP /* 到期時間 */,
	`DateRevoked` DATETIME NULL /* 撤銷日期 */,
	`UserSN` INTEGER NOT NULL REFERENCES `User` (`SN`) /* 使用者序號 */
